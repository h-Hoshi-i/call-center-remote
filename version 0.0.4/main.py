...
def gen_contact_screen(name:str):
    ...
    tk.Button(root, text="Copy PHONE#", command=lambda:genec.gen_contact(name,"phone"), bg="#E2D6FF").pack()
    tk.Button(root, text="Copy EMAIL", command=lambda:genec.gen_contact(name,"email"), bg="#E2D6FF").pack()
...
def admin_c_select_page_1():
    ...
    tk.Button(root, text="BACK", command=morning_email, bg="#C9A3D1").pack()
...
def admin_contact_screen(name):
    ...
    tk.Button(root, text="Copy PHONE#", command=lambda:admic.admin_contact(name,"phone"), bg="#E2D6FF").pack()
    tk.Button(root, text="Copy EMAIL", command=lambda:admic.admin_contact(name,"email"), bg="#E2D6FF").pack()
